...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { detaile: @collection.detaile, name: @collection.name } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { detaile: @collection.detaile, name: @collection.name } }
